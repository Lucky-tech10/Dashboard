...
export const mockKnowledge: KnowledgeArticle[] = [
  {
    id: '1',
    title: 'New Code',
    description: 'As an AI language model, I can provide you with an example code snippet that demonstrates how to use...'
  },
  {
    id: '2',
    title: 'Rowans First Day At Nursery Article',
    description: 'Title: 10 Essential Tips to Prepare Your Child for Their First Day at Rowans Nursery Introduction:The...'
  },
  {
    id: '3',
    title: 'Rowans First Day At Nursery Article',
